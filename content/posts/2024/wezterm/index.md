...
![screenshot of WezTerm's default look](01_default_look.png)
...
![screenshot of the WezTerm look we'll end up with at the end of this post](02_pretty_look.png)
...
![screenshot of the WezTerm's debug overlay](03_debug_overlay.png)
...
![screenshot of applying a colour scheme to WezTerm](04_colour_scheme.png)
...
![screenshot of many WezTerm terminal windows, each with a distinctive colour scheme](05_cornucopia.png)
...
<p>![screenshot of WezTerm in light and dark mode](06_light_v_dark.png)</p>
...
![screenshot of WezTerm after we've styled its window](07_window_styling.png)
...
![screenshot of WezTerm with a right status bar showing the system's hostname](08_status_bar.png)
...
![screenshot of WezTerm's command palette](09_command_palette.png)
...
![screenshot of WezTerm's with split panes](10_splits.png)
...
![screenshot of WezTerm's with the workspace switcher we've configured](11_workspace_switcher.png)
...
![screenshot of WezTerm with an enhanced status line, showing multiple segments in different colours](12_status_bar_enhanced.png)
